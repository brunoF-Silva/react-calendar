...
const CalendarApp = () => {
  ...
  const prevMonth = () => {
    // December must be the last current month
    setCurrentMonth((prevMonth) => (prevMonth === 0 ? 11 : prevMonth - 1))
    // Since the prevMonth is alright, if it is 11 so the year before is the current one - 1
  ...
  const nextMonth = () => {
    ...
    setCurrentYear((prevYear) => (currentMonth === 11 ? prevYear + 1 : currentYear))
  }
      ...
      <div className="events">
        ...
        <div className="event-popup">
          <div className="time-input">
            ...
            onChange={(e) => setEventTime({ ...eventTime, hours: e.target.value })} // This input is a controlled component
            />
